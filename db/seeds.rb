...
users = [
     {
       ...
       :admin => true,
       :password => "A%dmin1234",
       :password_confirmation => "A%dmin1234",
       :first_name => "Admin",
       :last_name => "",
       :user_id =>1
      },
     {
       ...
       :admin => false,
       :password => "A%2yankeessuck",
       :password_confirmation => "A%2yankeessuck",
       :first_name => "Jack",
       :last_name => "Mannino",
       :user_id => 2
     },
     {
       ...
       :admin => false,
       :password => "A%2alohaowasp",
       :password_confirmation => "A%2alohaowasp",
       :first_name => "Jim",
       :last_name => "Manico",
       :user_id =>3
     },
     {
       ...
       :admin => false,
       :password => "A%motocross1445",
       :password_confirmation => "A%motocross1445",
       :first_name => "Mike",
       :last_name => "McCabe",
       :user_id =>4
      },
     {
       ...
       :admin => false,
       :password => "A%2citrusblend",
       :password_confirmation => "A%2citrusblend",
       :first_name => "Ken",
       :last_name => "Johnson",
       :user_id =>5
      }
